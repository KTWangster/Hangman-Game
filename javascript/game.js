...
function startGame() {
    ...
    document.onkeyup = function (event) {
        ...
        // Function that displays keys already pressed. 
        ...
        // Regex to verify typedLetters() doesn't log regular or lowercase letters
        var pat = /^[a-z]+$/;
        ...
        function checkList(word) {
            ...
            var wrongCounter = 0;
            // for Loop that iterates through word and checks if letter matches user guess.
            for (i = 0; i < word.length; i++) {

                if (word[i] === userGuess) {

                    // for loop that changes _ to correct letter(s) guessed
                    for (i = 0; i < word.length; i++) {
                        if (word[i] === userGuess) {
                    ...
                    if (saveWord === word) {
                        ...
                        // Pressing the enter key after winning resets game.
                        document.onkeyup = function (event) {
                ...
                if (wrongCounter === word.length) {
                    ...
                    // For loop to check array for already guessed
                    ...
                    var guessCounter = "Wins: " + wins + "<br />" +
                        "Losses: " + losses + "<br />" +
                        "Guesses Remaining: " + guessesRemaining;
                    document.querySelector("#scoreCounter").innerHTML = guessCounter;
